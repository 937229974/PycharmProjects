...
rf = RandomForestClassifier(n_estimators= 60, max_depth=13, min_samples_split=120,
                                 min_samples_leaf=20,max_features=(col_x-1) ,oob_score=True, random_state=10)
...
cnf_matrix = confusion_matrix( y_test,y_pred,labels=None, sample_weight=None)
...
plt.figure()
plot_confusion_matrix(cnf_mxdddatrix, classes=classname, normalize=True,
